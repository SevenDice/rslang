  ...
  return (
    <div className='levels-info'>
      <div onClick={stopProp} className='levels-info-card'>
        ...
        <p>
          The Lingvist algorithm uses spaced repetition, showing you the words you need to practice
          more often, so the above scale can go up as well as down over time.
        </p>
        <p>
          Make sure to practice as often as you can, and always try your best to get the answer
          correct.
        </p>
        <hr />
